%% 20240409 Pure-tune Threshold by PCH
...
function [paramatrix,paramatrix_prac] = buildmatrix2

filter_noise=1:3;        % 滤波水平的个数

StaircaseNum=[1 2];     % 每个condition有2个staircase
trialpercondition=40;   % 80个trials
trialpercondition_practice=1;
[x0,x1]=ndgrid(filter_noise,StaircaseNum);   % 生成参数组合矩阵
